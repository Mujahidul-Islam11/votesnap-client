...
const Subscribe = () => {
    return (
        <div className='px-4 md:px-16 my-6 md:my-12 flex-col md:flex-row justify-center md:justify-between flex h-60 bg-opacity-30 items-center rounded-lg border'>
            <div className=''>
